...
$this->breadcrumbs=array(
	...
	$model->id_observaciones=>array('view','id'=>$model->id_observaciones),
	'Update',
);
...
$this->menu=array(
	...
	array('label'=>'View Observaciones', 'url'=>array('view', 'id'=>$model->id_observaciones)),
	array('label'=>'Manage Observaciones', 'url'=>array('admin')),
);
?>

<h1>Update Observaciones <?php echo $model->id_observaciones; ?></h1>

...
class Observaciones extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_informe, id_unidad, id_grupo, id_tipo_criticidad, id_tipo_observacion, id_risego, id_clasificacion, id_estado, id_tema', 'numerical', 'integerOnly'=>true),
	...
	*/
	...
	public function relations()
	{
		...
		return array(
			...
			'observacionesAuditor' => array(self::HAS_MANY, 'ObservacionesAuditor', 'id_auditor'),
			...
			'idTemaInteres' => array(self::BELONGS_TO, 'TemaInteres', 'id_tema'),

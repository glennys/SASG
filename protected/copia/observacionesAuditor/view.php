...
$this->menu=array(
	...
	array('label'=>'Modificar Observaciones Auditor', 'url'=>array('update', 'observaciones'=>$model->observaciones, 'id_auditor'=>$model->id_auditor, 'fecha_asignacion'=>$model->fecha_asignacion)),

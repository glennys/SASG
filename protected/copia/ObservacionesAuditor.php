...
class ObservacionesAuditor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('observaciones, id_auditor, fecha_asignacion', 'required'),
			array('observaciones, id_auditor, otro', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('observaciones, id_auditor, fecha_asignacion, otro', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'idObservaciones' => array(self::BELONGS_TO, 'Observaciones', 'observaciones'),
		);
	}

 ...
 */
class RolModulos extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_rol, id_permisos', 'required'),
			array('id_rol, id_permisos', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_rol, id_permisos', 'safe', 'on'=>'search'),
		);
	}

 ...
 */
class ObservacionesConsultor extends CActiveRecord
{
	/**
	...
	{
		return 'auditoria.observaciones_consultor';
	}
	...
	public function rules()
	{
		...
		return array(
			array('id_observaciones, id_consultor, fecha_asignacion', 'required'),
			array('id_observaciones, id_consultor, otro', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_observaciones, id_consultor, fecha_asignacion, otro', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idConsultor' => array(self::BELONGS_TO, 'Empleado', 'id_consultor'),

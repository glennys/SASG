...
/**
 * This is the model class for table "auditoria.tipo_criticidad".
 *
 * The followings are the available columns in table 'auditoria.tipo_criticidad':
 ...
 */
class TipoCriticidad extends CActiveRecord
{
	/**
	...
	{
		return 'auditoria.tipo_criticidad';
	}
	...
	public function relations()
	{
		...
		return array(
			'observaciones' => array(self::HAS_MANY, 'Observaciones', 'id_tipo_criticidad'),
		);
	}
	 ...
	 * @return TipoCriticidad the static model class
	 */

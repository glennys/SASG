...
class ObservacionesAuditorController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ObservacionesAuditor']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_auditor));
		}
	 ...
	 * @return ObservacionesAuditor the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ObservacionesAuditor::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ObservacionesAuditor $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='observaciones-auditor-form')
		{
